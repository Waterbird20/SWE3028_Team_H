...
Using Transformer model, it is expected that it performs the best and reflects the other information such as news, stock index and corporate disclosure unlike the other models.
